export const MEMBER_PROFILES = [
  {
    ...
    position: 'CEO',
    summary:
      'Francesca Frattaroli, BSME - Maker, educator, & lifelong learner based in Portland, OR',
  },
  {
    name: 'Morgan Litton',
    image: 'profile.png',
    position: 'COO',
    summary:
      'An electrical engineer in academics, and a software engineer by trade. Morgan has a PhD in electrical engineering, and has been building professional software for over 10 years. He has built and led teams focused on machine learning, robotics, big data, software security, and much more. He currently has every AWS certification, including specialist certifications.',
  },
  {
    name: 'Jordan Laurent',
    image: 'profile.png',
